...
SimpleModel.prototype.field = function(fieldName, options)
{
    if (this.fields === undefined) this.fields = {};
    this.fields[fieldName] = options || { required: false, type: 'string' };
};

SimpleModel.prototype.isValid = function() {
...
SimpleModel.prototype.getErrors = function() {

    return this.errors || false;

};

SimpleModel.prototype.toObject = function() {
...
SimpleModel.prototype.init = function(initial)
{
    this.errors = [];
