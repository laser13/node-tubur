...
Field.prototype.check = function(value)
{
    ...
    // Если значение должно быть объектом класса EasyStructure
...
function EasyStructure(initial)
{
    ...
    fieldSet.forEach(function(fieldName) {
        ...
        if (self[fieldName] instanceof Field)
        {
...
EasyStructure.prototype.isValid = function() {
    ...
    return filter.sanitize(this.errors.length).toBoolean();
...
EasyStructure.prototype.toObject = function() {
    ...
    fieldSet.forEach(function(key) {
        ...
        if (self[key] instanceof Field && self[key].value !== undefined) {
...
module.exports.EasyStructure = EasyStructure;
