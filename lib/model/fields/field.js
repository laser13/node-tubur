...
{
    return utils.hasKey(this.options, optionName) ? ( utils.hasKey(this.options[optionName], key) ) ? this.options[optionName][key] : null : null;
};
...
Field.prototype.setOption = function setOption(optionName, key, value)
{
    ...
    {
        if ( utils.hasKey(optionKeys, optionName) && utils.hasKey(optionKeys[optionName], opt.key.DEFAULT))
        {
...
Field.prototype.getErrors = function getErrors()
{
