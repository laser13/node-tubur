...
var defaultErrorMsg = {
    ...
    type:       'value must be a %{option}',
    instance:   'value must be an instance of %{option}',
    max:        'value must be less than or equal %{option}',
    min:        'value must be greater than or equal %{option}',
    range:      'value out of range %{option}',
...
var optionKeys = {
    ...
    type:       { required: true, default: { val: 'mixed', strict: false, msg: defaultErrorMsg.type }, msg: defaultErrorMsg.type },
...
var baseTypes = ['mixed', 'string', 'number', 'boolean', 'object', 'function'];
