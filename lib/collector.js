...
//                console.log(stack, str.stack);
                if (options.showStack) data['stack'] = stack;
...
function Collector(options) {
    ...
    if ( !utils.hasKey(options, 'scribeSet') ) {
        ...
        if (options.colored) {
            defaultScribeSet = [
                new ScribeStruct({ name: 'info', options: new ScribeOptStruct({ showHead: true, headTitle: '[ INFO ]', color: 'blue', colored: options.colored, output: options.output, path: options.path, mongoUrl: options.mongoUrl, collectionName: 'info', fileName: 'info', showCodeLine: options.showCodeLine, showStack: options.showStack }).toObject() }).toObject(),
                new ScribeStruct({ name: 'notice', options: new ScribeOptStruct({ showHead: true, headTitle: '[ NOTICE ]', color: 'yellow', colored: options.colored, output: options.output, path: options.path, mongoUrl: options.mongoUrl, collectionName: 'notice', fileName: 'notice', showCodeLine: options.showCodeLine, showStack: options.showStack }).toObject() }).toObject(),
                ...
                new ScribeStruct({ name: 'add', options: new ScribeOptStruct({ showHead: false, colored: options.colored, output: options.output, path: options.path, mongoUrl: options.mongoUrl, collectionName: 'info', fileName: 'info', showStack: options.showStack }).toObject() }).toObject()
            ];
        }
        else {
            defaultScribeSet = [
                new ScribeStruct({ name: 'info', options: new ScribeOptStruct({ showHead: true, headTitle: '[ INFO ]', colored: options.colored, output: options.output, path: options.path, mongoUrl: options.mongoUrl, collectionName: 'info', fileName: 'info', showCodeLine: options.showCodeLine, showStack: options.showStack }).toObject() }).toObject(),
                new ScribeStruct({ name: 'notice', options: new ScribeOptStruct({ showHead: true, headTitle: '[ NOTICE ]', colored: options.colored, output: options.output, path: options.path, mongoUrl: options.mongoUrl, collectionName: 'notice', fileName: 'notice', showCodeLine: options.showCodeLine, showStack: options.showStack }).toObject() }).toObject(),
